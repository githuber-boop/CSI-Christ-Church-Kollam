  ...
  const addFamilyMember = () => {
    setFormData({
      ...
      familyMembers: [
        ...
        { name: "", dob: "", confirmation: "", baptism: "", confirmed: false, baptised: false },
      ],
    });
  };
      ...
      <main className="user-form admin-content">
        ...
        <form onSubmit={submitForm} className="new_user-form">
          ...
          <label htmlFor="baptism">
            Baptism Date:
            {!baptised ? (
              <input type="text" readOnly onPaste={handlePaste} name="baptism" value={formData.baptism} onChange={handleChange} />
            ) : (
              <input type="text" name="baptism" value={formData.baptism} disabled />
            )}
            <div className="block-container"><label><input type="checkbox" className="checkbox" checked={baptised} onChange={handleMainBaptisedToggle} /> Mark as "Baptised"</label></div>
          </label>
          <label htmlFor="confirmation">
            Confirmation Date:
            {!confirmed ? (
              <input type="text" readOnly onPaste={handlePaste} name="confirmation" value={formData.confirmation} onChange={handleChange} />
            ) : (
              <input type="text" name="confirmation" value={formData.confirmation} disabled />
            )}
            <div className="block-container"><label><input type="checkbox" className="checkbox" checked={confirmed} onChange={handleMainConfirmationToggle} /> Mark as "Confirmed"</label></div>
          </label>
          ...
          {formData.familyMembers.map((member, index) => (
            <div key={index} className="family-member">
              ...
              <label>
                Baptism Date:
                {!member.baptised ? (
                  <input type="text" readOnly name="baptism" onPaste={handlePaste} value={member.baptism} onChange={(e) => handleFamilyMemberChange(index, e)} />
                ) : (
                  <input type="text" name="baptism" value={member.baptism} disabled />
                )}
                <div className="block-container"><label><input type="checkbox" onPaste={handlePaste} className="checkbox" checked={member.baptised} onChange={() => handleBaptisedToggle(index)} /> Mark as "Baptised"</label></div>
              </label>
              ...
              <label>
                Confirmation Date:
                {!member.confirmed ? (
                  <input type="text" readOnly name="confirmation" value={member.confirmation} onChange={(e) => handleFamilyMemberChange(index, e)} />
                ) : (
                  <input type="text" name="confirmation" value={member.confirmation} disabled />
                )}
                <div className="block-container"><label><input type="checkbox" className="checkbox" checked={member.confirmed} onChange={() => handleConfirmationToggle(index)} /> Mark as "Confirmed"</label></div>
              </label>

              <button type="button-member" className="removeMember" onClick={() => removeFamilyMember(index)}>Remove Family Member</button>
            </div>
          ))}
          <button type="button-member"  onClick={addFamilyMember}>Add Family Member</button>
